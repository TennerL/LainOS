...
static const kernel_export_t kernel_exports[] = {
    ...
    KERNEL_EXPORT("debug_puts", debug_puts),
    KERNEL_EXPORT("debug_put_hex64", debug_put_hex64),
    KERNEL_EXPORT("debug_put_dec64", debug_put_dec64),
    ...
    KERNEL_EXPORT("sprintf", sprintf),
    KERNEL_EXPORT("floor", floor),
    KERNEL_EXPORT("trunc", trunc),
    KERNEL_EXPORT("fmod", fmod),
    KERNEL_EXPORT("sqrt", sqrt),
    KERNEL_EXPORT("sin", sin),
    KERNEL_EXPORT("cos", cos),
    KERNEL_EXPORT("tan", tan),
    KERNEL_EXPORT("atan", atan),
    KERNEL_EXPORT("atan2", atan2),
    KERNEL_EXPORT("asin", asin),
    KERNEL_EXPORT("acos", acos),
    KERNEL_EXPORT("exp", exp),
    KERNEL_EXPORT("log", log),
    KERNEL_EXPORT("log2", log2),
    KERNEL_EXPORT("log10", log10),
    KERNEL_EXPORT("pow", pow),
    KERNEL_EXPORT("cbrt", cbrt),
    KERNEL_EXPORT("fabs", fabs),
    KERNEL_EXPORT("difftime", difftime),
    KERNEL_EXPORT("gmtime_r", gmtime_r),
    KERNEL_EXPORT("localtime_r", localtime_r),
    KERNEL_EXPORT("mktime", mktime),
    KERNEL_EXPORT("strptime", strptime),
    KERNEL_EXPORT("strftime", strftime),
    KERNEL_EXPORT("setjmp", setjmp),
    KERNEL_EXPORT("longjmp", longjmp),
    ...
    KERNEL_EXPORT("draw_text_sized_at_pixel", console_draw_text_sized_at_pixel),

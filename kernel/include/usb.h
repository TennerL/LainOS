...
typedef struct {
    ...
    uint32_t mouse_hid_report_size;
    uint32_t mouse_report_id;
    uint32_t mouse_report_parsed;
    uint32_t mouse_buttons_bit;
    uint32_t mouse_x_bit;
    uint32_t mouse_y_bit;
    uint32_t mouse_wheel_bit;
    uint32_t mouse_axis_size;
    uint32_t mouse_wheel_size;
    uint32_t mouse_last_transferred;
    uint32_t mouse_last_report0;
    uint32_t mouse_last_report1;
    uint32_t mouse_last_report2;
    uint32_t mouse_last_report3;
    uint32_t mouse_last_report4;
    int32_t mouse_last_wheel;
    uint32_t mouse_last_nonzero_transferred;
    uint32_t mouse_last_nonzero_report0;
    uint32_t mouse_last_nonzero_report1;
    uint32_t mouse_last_nonzero_report2;
    uint32_t mouse_last_nonzero_report3;
    uint32_t mouse_last_nonzero_report4;
    int32_t mouse_last_nonzero_wheel;
    uint32_t enum_stage;
    uint32_t enum_port;

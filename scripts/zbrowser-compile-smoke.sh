...
check_output "build/zbrowser-smoke/install/kernel_z_selfhost/install/clock_math.zo"
...
check_buildlog_line "build/zbrowser-smoke/kernel_z_selfhost/kernel_z_selfhost.buildlog" "objects 3"
